...
CREATE TABLE news_articles (
    ...
    parent_article_id      INTEGER REFERENCES news_articles(id) ON DELETE CASCADE,
    prev_article_id        INTEGER REFERENCES news_articles(id) ON DELETE CASCADE,
    next_article_id        INTEGER REFERENCES news_articles(id) ON DELETE CASCADE,
    first_child_article_id INTEGER REFERENCES news_articles(id) ON DELETE CASCADE,
    title       TEXT    NOT NULL,
    poster      TEXT,
